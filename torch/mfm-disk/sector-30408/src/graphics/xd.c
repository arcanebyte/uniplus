...
static char version [] =
   "(C) Copyright 1985 TORCH Computers Ltd Version 2.00\nTriple X";
 ...
 *   1.10		Upgrade released with new library.
 *
 *   1.20		Bug fix in libg3.c due to PenDown required on close.
 *   1.20a		Bug fix in libg2.c due to PenDown required in label.
 *   2.00               Rewritten by CDWF to do dotted lines.
 */
