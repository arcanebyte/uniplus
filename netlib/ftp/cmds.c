#ifndef lint
static char sccsid[] = "@(#)cmds.c	4.1 (Berkeley) 1/15/83";
#endif
	...
	char *argv[];
{
	...
	printf("Verbose: %s; Bell: %s; Prompting: %s; Passive: %s\n", 
		onoff(verbose), onoff(bell), onoff(interactive), onoff(passive));
}
...
/*
 * Toggle passive mode: the server listens for the data connection and
 * ftp connects to it, which works through NAT such as LisaEm's slirp.
 */
/*VARARGS*/
setpassive()
{
