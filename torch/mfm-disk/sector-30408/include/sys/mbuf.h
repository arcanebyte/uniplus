/* NFSSRC @(#)mbuf.h	2.1 86/04/11 */
/*	@(#)mbuf.h 1.1 85/05/30 SMI; from UCB 4.18 83/03/25	*/
...
#define	NMBCLUSTERS	32			/* # of virt pages for mbufs */
...
#ifdef	KERNEL
#ifndef AUTOCONFIG
extern	struct mbuf mbutl[];		/* mbuf cluster area */
extern	struct mbuf mbufbufs[];		/* actual mbuf area */
#else
extern	struct mbuf *mbutl;		/* mbuf cluster area */
extern	struct mbuf *mbufbufs;		/* actual mbuf area */
#endif AUTOCONFIG
struct	mbstat mbstat;
struct	mbuf *mfreep, *mclfree;
