...
1. **Buffer cache sized at boot** (Disk speed and space, item 1): written, to be built and measured on the Lisa.
2. **ProFile queue order** (Disk speed and space, items 2 and 3), after measuring the cache.
