...
#define DEFUWIN     29       /* Set default window */
#define HOMEC       30
#define DEFTEXT     31       /* Set default text state */
...
#define SETEDBITS   'K'      /* Set edit area */

#define TRACKFORM   'L'      /* Set Tracking form */
#define TRACKPAT    'M'      /* Set tracking half-tone */
#define TRACKMODE   'N'      /* Set tracking mode */
#define TRACKSIZE   'O'      /* Set tracking pen size */
