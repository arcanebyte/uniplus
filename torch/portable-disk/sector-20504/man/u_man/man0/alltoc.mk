TOOLS=/v/dist/dist/usr/man/tools
ATMPDIR=/v/dist/dist/usr/man/a_man/man0
AMANDIR=/v/dist/dist/usr/man/a_man
TMPDIR=/v/dist/dist/usr/man/u_man/man0
MANDIR=/v/dist/dist/usr/man/u_man
...
cat $TMPDIR/cattoc $ATMPDIR/cattoc > $TMPDIR/alltoc

ptx -r -t -b $TOOLS/break -f -w $P -i $TOOLS/ignore $TMPDIR/alltoc $MANDIR/man0/ptxx
