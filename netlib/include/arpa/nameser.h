...
/*
 * Lisa: from 4.3BSD.  The 68000 cc assigns bit fields from the most
 * significant bit, as the kernel's net/ip.h and net/tcp.h rely on, so
 * mc68000 takes the "bit zero on left" layout.  Needs u_char, u_short
 * and u_long from bsd.h.
 */
...
|| defined (tahoe) || defined (mc68000) || defined (BIT_ZERO_ON_LEFT)
