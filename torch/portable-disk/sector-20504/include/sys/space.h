...
char	bspace[NBUF * SBUFSIZE + sizeof(int) - 1];	/* buffer space */
...
struct map vmap[VMAPSIZ] = { mapdata(VMAPSIZ) };
...
#endif
	BSIZE,
	NMMU,		/* CXMAPSIZ for sun mmu */
	CLKTICK,
	HZ,
	USIZE,
	PAGESHIFT,
	NULL,		/* PAGEMASK for sun mmu */
	SEGSHIFT,
	NULL,		/* SEGMASK for sun mmu */
	USTART,
	UEND,
#ifdef lint
	&callout[NCALL],
