#ifndef lint
static char sccsid[] = "@(#)cmdtab.c	4.2 (Berkeley) 1/15/83";
#endif
#include "ftp_var.h"
...
int	pwd(), makedir(), removedir(), setpassive();
...
char	pasvhelp[] =	"toggle passive mode (PASV) data connections";
