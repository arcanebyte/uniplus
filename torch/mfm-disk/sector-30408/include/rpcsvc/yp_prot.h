...
/* _Origin_ = Sun Microsystems  NFSSRC 2.1 86/04/14 Copyr 1985 Sun Micro */
/* sccsid = @(#)yp_prot.h	UniPlus V.2.1.1 (Sun 2.1) */

/*
 * This file contains symbols and structures defining the rpc protocol
 * between the yellowpages clients and the yellowpages servers.  The servers
 * are the yp database servers, and the yp binders.  
 */
